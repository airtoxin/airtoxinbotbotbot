  ...
  return function(tweetObj) {
    ...
    self.getIndices = function() {
      ...
      var hashtags = ent.hashtags
        ? ent.hashtags.map(function(d) {
            return d.indices;
          })
        : [];
      var medias = ent.media
        ? ent.media.map(function(d) {
            return d.indices;
          })
        : [];
      var urls = ent.urls
        ? ent.urls.map(function(d) {
            return d.indices;
          })
        : [];
      var mentions = ent.user_mentions
        ? ent.user_mentions.map(function(d) {
            return d.indices;
          })
        : [];
